...
export function OnboardingWizard({ email, profile, initialCnae }: OnboardingWizardProps) {
  ...
  const [form, setForm] = useState({
    ...
    atividadesRealizadas: profile?.atividades_realizadas ?? '',
  })
  ...
  const cardStatus = useMemo(() => {
    return [
      ...
      Boolean(cnae && form.tipoMei && form.municipio && form.uf && form.atividadesRealizadas),
  ...
  const fieldIds = {
    ...
    atividadesRealizadas: `${idBase}-atividades-realizadas`,
    ...
    },
    {
      ...
      body: (
        <div style={{ display: 'grid', gap: 14 }}>
          ...
          <div>
            <FieldLabel htmlFor={fieldIds.atividadesRealizadas}>Atividades realizadas</FieldLabel>
            <textarea
              id={fieldIds.atividadesRealizadas}
              value={form.atividadesRealizadas}
              onChange={event => setValue('atividadesRealizadas', event.target.value)}
              placeholder="Ex.: desenvolvimento de sites, manutenção de sistemas, consultoria técnica"
              required
              rows={4}
              style={{
                width: '100%',
              ...
              >
                ...
                >
                  ...
                  <div aria-hidden="true" style={{
                    ...
                    color: isDone ? 'var(--ink-on-accent)' : 'var(--text3)',
        ...
        <aside className="onboarding-sidebar" style={{
          ...
          <button
            ...
            style={{
              ...
              color: complete ? 'var(--ink-on-accent)' : 'var(--text3)',
              fontSize: 14,
              fontWeight: 900,
