  ...
  if (clients.length === 0) {
    return (
      <div style={{ border: '1px solid var(--border)', background: 'var(--bg1)', borderRadius: 'var(--radius)', padding: 22 }}>
        ...
        <Link href="/contador/clientes/novo" style={{ color: '#000', background: 'var(--lime)', borderRadius: 'var(--radius)', padding: '10px 13px', fontWeight: 900, fontSize: 13, textDecoration: 'none' }}>
          Cadastrar cliente
        </Link>
      </div>
    )
