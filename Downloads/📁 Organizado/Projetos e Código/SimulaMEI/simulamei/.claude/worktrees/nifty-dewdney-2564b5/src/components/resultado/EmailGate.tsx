    ...
    >
      ...
      <div>
        <div style={{
          ...
          <span style={{ color: 'var(--lime)', fontSize: 11, fontWeight: 700 }}>⚡ ANÁLISE COMPLETA GRATUITA</span>
        </div>
        <h3 style={{
      ...
      <form onSubmit={handleSubmit}>
        <div style={{ marginBottom: 12 }}>
          ...
          <input
            ...
            style={{
              ...
              borderRadius: 'var(--radius)', color: 'var(--text1)', fontSize: 14,
        ...
        <button
          ...
          style={{
            ...
            background: 'linear-gradient(135deg, var(--lime), #a0d020)',
            color: '#000',
      ...
      <style>{`@media(max-width:900px){.gate-grid{grid-template-columns:1fr!important;}}`}</style>
    </div>
  )
}
