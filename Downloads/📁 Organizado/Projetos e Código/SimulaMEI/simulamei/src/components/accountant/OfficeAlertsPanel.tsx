      ...
      {openAlerts.length > 0 ? (
        <div className="dashboard-main-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(2, minmax(0, 1fr))', gap: 12 }}>
          {openAlerts.map(alert => (
            <article key={alert.id} className="dashboard-panel surface-hover" style={{ border: '1px solid var(--border)', background: 'var(--bg1)', borderRadius: 'var(--radius)', padding: 16 }}>
        ...
        <div className="dashboard-panel" style={{ border: '1px solid var(--border)', background: 'var(--bg1)', borderRadius: 'var(--radius)', padding: 16 }}>
