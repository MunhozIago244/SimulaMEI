  ...
  it('penaliza excesso grave, falta de fator R e CNAE vazio', () => {
    const score = calcFiscalScore(makeResultado({
      ...
      fatorR: {
        ...
        folhaMinimaAnual: 45_360,
        folhaMinimaMensal: 3_780,
        aumentoFolhaMensalNecessario: 2_780,
        economiaAnual: 4_500,
        memoriaCalculo: {
          aliquotaEfetivaAnexoV: 0.155,
          aliquotaEfetivaAnexoIII: 0.06,
          rbt12Projetado: 162_000,
  ...
  it('mantem score saudável em cenário estável', () => {
    const score = calcFiscalScore(makeResultado({
      ...
      fatorR: {
        ...
        folhaMinimaAnual: 17_920,
        folhaMinimaMensal: 1_493.33,
        aumentoFolhaMensalNecessario: 0,
        economiaAnual: 3_200,
        memoriaCalculo: {
          aliquotaEfetivaAnexoV: 0.155,
          aliquotaEfetivaAnexoIII: 0.06,
          rbt12Projetado: 64_000,
          diferencaAliquota: 0.095,
          economiaAnual: 3_200,
        },
      },
