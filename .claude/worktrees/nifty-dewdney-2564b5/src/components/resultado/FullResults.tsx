...
import { calcularSimples, gerarOportunidadesFiscais } from '@/lib/tributario'
    ...
    <section id="resultado-completo" style={{ padding: '60px 0', background: 'var(--bg0)' }}>
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 40px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 16, marginBottom: 48 }}>
          ...
          <div style={{ marginLeft: 'auto', display: 'flex', gap: 10 }}>
            <Link
              ...
              style={{
                padding: '10px 18px', background: 'var(--bg2)', border: '1px solid var(--border2)',
                borderRadius: 'var(--radius)', color: 'var(--text1)', fontSize: 13, fontWeight: 500,
            ...
            <Link
              ...
              style={{
                padding: '10px 18px', background: 'var(--lime)', color: '#000',
        ...
        <div style={{
          ...
          <p style={{
            fontSize: 11, color: 'var(--text3)', marginBottom: 28,
            background: 'var(--bg2)', borderRadius: 'var(--radius)',
            padding: '6px 10px', display: 'inline-block',
          }}>
            ℹ️ A simulação considera a atividade predominante do CNAE.
              ...
              return (
                ...
                >
                  ...
                  <div style={{
                    ...
                    transition: 'height .5s cubic-bezier(.34,1.56,.64,1), background .2s',
                    transformOrigin: 'bottom',
                    animation: `barGrow .6s ${i * 0.1}s cubic-bezier(.34,1.56,.64,1) both`,
                    display: 'flex', alignItems: 'flex-start', justifyContent: 'center',
                    paddingTop: 8,
                    boxShadow: isMelhor ? `0 0 24px ${regime.color}55, 0 0 8px ${regime.color}30` : 'none',
                  }}>
                    {isMelhor && <span style={{ fontSize: 16 }}>★</span>}
                  </div>
