  ...
  if (!latest) {
    return (
      <div style={{ border: '1px solid var(--border)', background: 'var(--bg1)', borderRadius: 'var(--radius)', padding: 18 }}>
        ...
        <Link href={`/contador/clientes/${clientId}/simular`} style={{ color: '#000', background: 'var(--lime)', borderRadius: 'var(--radius)', padding: '10px 12px', fontWeight: 950, fontSize: 13, textDecoration: 'none', display: 'inline-flex' }}>
          Simular agora
        </Link>
      </div>
    )
